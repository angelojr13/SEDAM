...
const BOARD_LABELS: BoardLabel[] = [
  { color: LABEL_COLOR.RED, text: "ROJO" },
  { color: LABEL_COLOR.ORANGE, text: "NARANJA" },
  { color: LABEL_COLOR.YELLOW, text: "AMARILLO" },
  { color: LABEL_COLOR.GREEN, text: "VERDE" },
  { color: LABEL_COLOR.TEAL, text: "CELESTE" },
  { color: LABEL_COLOR.BLUE, text: "AZUL" },
  { color: LABEL_COLOR.PURPLE, text: "MORADO" }
]; 
